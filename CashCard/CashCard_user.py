...
if '__main__' == __name__:
    ...
    #CahCard.py 모듈 안의 balance_won 값이 증가
    CashCard_module.deposit(10000)

    #CashCard.py 모듈 안의 check_balance() 함수를 호출
    #CashCard.py 모듈의 balance_won 값이 반환
    ...
    print("CarshCard_module : %s" % CashCard_module)
    print("mySitstersCard_module : %s" %mySistersCard_module)
